        ...
        <table className="w-full min-w-full">
          <thead>
            <tr className="bg-purple-600 text-white">
              <th className="text-left py-2 sm:py-3 px-2 sm:px-4 font-medium text-xs sm:text-sm">Period</th>
              <th className="text-left py-2 sm:py-3 px-2 sm:px-4 font-medium text-xs sm:text-sm">Number</th>
              <th className="text-left py-2 sm:py-3 px-2 sm:px-4 font-medium text-xs sm:text-sm">Big/Small</th>
              <th className="text-left py-2 sm:py-3 px-2 sm:px-4 font-medium text-xs sm:text-sm">Color</th>
            </tr>
          </thead>
          <tbody>
            {gameHistoryData.map((game, index) => (
              <tr key={index} className="border-b border-gray-700">
                <td className="py-2 sm:py-3 px-2 sm:px-4 text-white text-xs sm:text-sm">{game.period}</td>
                ...
                <td className="py-2 sm:py-3 px-2 sm:px-4 text-white text-xs sm:text-sm">{game.bigSmall}</td>
                <td className="py-2 sm:py-3 px-2 sm:px-4">
          ...
          <table className="w-full min-w-full">
            <thead>
              <tr className="border-b border-gray-700">
                <th className="text-left py-2 sm:py-3 px-2 sm:px-4 text-gray-300 font-medium text-xs sm:text-sm">Period</th>
                <th className="text-left py-2 sm:py-3 px-2 sm:px-4 text-gray-300 font-medium text-xs sm:text-sm">Number</th>
              </tr>
            </thead>
            <tbody>
        ...
        <div className="bg-gray-800 rounded-xl p-3 sm:p-4">
          ...
          <div className="grid grid-cols-3 gap-2 sm:gap-3">
            <button
              ...
              className={`py-3 sm:py-4 px-2 sm:px-4 rounded-lg font-semibold transition-colors text-sm sm:text-base ${
                selectedColor === 'green'
